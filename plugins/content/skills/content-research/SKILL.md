...
|-------------|----------------|--------------|
| Twitter/X | `"[topic]" site:twitter.com expert OR founder OR CEO` | Thought leaders with relevant threads |
| LinkedIn | `"[topic]" site:linkedin.com "head of" OR "VP" OR "director"` | Industry practitioners |
| Publications | `"[topic]" site:forbes.com OR techcrunch.com author` | Writers who cover this space |
| Podcasts | `"[topic]" podcast guest expert` | Guests who've spoken publicly |
| Academic | `"[topic]" professor OR researcher site:edu` | Researchers with published work |
...
- [references/blog-posts.md](references/blog-posts.md) - Long-form article patterns
- [references/social-media.md](references/social-media.md) - Platform-specific formats
- [references/press-releases.md](references/press-releases.md) - PR and announcements
- [references/ai-search-optimization.md](references/ai-search-optimization.md) - Deep dive on AIO tactics
